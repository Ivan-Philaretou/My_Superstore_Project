-- 0. Make Sure you import your/my cleaned version of Sample_Superstore_2017_Cleaned.csv into a Table called seed_data
...
-- 1.1 Run Oracle_GenerateCalendarDates_Proc Procedure to Insert Data
...
-- 2.3 Insert Data via Oracle_Insert_Names

-- 2.4 Run Oracle_GenerateNames_Func Function

-- 2.4 Run Oracle_GenerateNames_Proc Procedure to Insert New Generate Names
...
-- 3.2 Run Oracle_Customer_Address_Proc
...
-- If you have decided to fix my data simply uncomment the brand_name
...
-- 6.2 Run Oracle_GenerateProductPrices_Proc
...
-- 8.1 Run Oracle_GenerateOrders_Proc
...
-- 8.2 Export Orders Table to [orders.csv] and Place it into [Superstore Project] Folder
